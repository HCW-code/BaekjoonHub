...
//				System.out.println(tmp.num + " " + Math.pow(10, count));
//				System.out.println(tmp.num / (int)Math.pow(10, count));
...
//		System.out.println(answerNum1 + " " + answerCount1);
//		System.out.println(answerNum2 + " " + answerCount2);
